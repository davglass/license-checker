 ...
 */
exports.asJson = function(sortedModules, customFormat, toBase64) {
    var output;
                ...
                for (moduleProp in module) {
                    if (module.hasOwnProperty(moduleProp)) {
                        ...
                        if (customFormat.hasOwnProperty(moduleProp)) {
                            if (toBase64) {
                                output[moduleName][moduleProp] = Buffer.from(sortedModules[moduleKey][moduleProp]).toString('base64');
                            } else {
